...
session.findById("wnd[0]/usr/ctxtS_DATE-LOW").text = FormatDateTime(dateadd("d",-60,dt),vbShortDate)
...
session.findById("wnd[2]/usr/ssub%_SUBSCREEN_FREESEL:SAPLSSEL:1105/ctxt%%DYN001-LOW").text = "/SUPPORT ECS"
